                    ...
                    <div class="tile-body">
                        <form id="formRol" name="formRol">
                            ...
                            <div class="form-group">
                                ...
                                <input id="txtNombre" class="form-control" name="txtNombre" type="text" placeholder="Nombre del Rol" required="">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select id="listStatus" class="form-control" name="listStatus" required="">
